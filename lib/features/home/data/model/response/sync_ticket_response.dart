class SnycTicketResponse {
  ...
  final int? v;
  final Event? event;
  final String? snycTicketResponseId;
  ...
  SnycTicketResponse({
    ...
    this.v,
    this.event,
    this.snycTicketResponseId,
  });

  SnycTicketResponse copyWith({
    String? id,
    int? ticketId,
    int? eventId,
    String? buyerAddress,
    ...
    String? snycTicketResponseId,
      ...
      SnycTicketResponse(
        ...
        snycTicketResponseId: snycTicketResponseId ?? this.snycTicketResponseId,
      );

  factory SnycTicketResponse.fromJson(Map<String, dynamic> json) => SnycTicketResponse(
        id: json["_id"],
