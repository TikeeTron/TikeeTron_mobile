...
class UIExpandablePageView extends StatefulWidget {
  ...
  @override
  _UIExpandablePageViewState createState() => _UIExpandablePageViewState();
}

class _UIExpandablePageViewState extends State<UIExpandablePageView> {
  ...
  @override
  void didUpdateWidget(covariant UIExpandablePageView oldWidget) {
  ...
  bool _shouldReinitializeHeights(UIExpandablePageView oldWidget) {
