...
class UIScaleButton extends StatefulWidget {
  const UIScaleButton({
    super.key,
    required this.child,
    this.onTap,
    this.begin = 1.0,
    this.end = 0.96,
    this.beginDuration = const Duration(milliseconds: 120),
  ...
  @override
  State<UIScaleButton> createState() => _UIScaleButtonState();
}

class _UIScaleButtonState extends State<UIScaleButton>
    with SingleTickerProviderStateMixin<UIScaleButton> {
